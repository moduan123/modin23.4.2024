...
<?php include_once '../handel/handelproudact.php' ?>
<?php
$id = intval($_GET["id"]);
$prodect = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM products WHERE id =$id"));
...
<html>
    ...
    <div class="col-8 mx-auto">
        <form class="border rounded p-3 m-3 shadow-lg p-3 mb-5 bg-white" method="POST" enctype="multipart/form-data"
            action="../handel/handelproudact.php">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="price" value=<?php echo $prodect['price'] ?> name="price" rows="3"></textarea>
            </div>
            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <textarea class="form-control" id="description" value=<?php echo $prodect['category_id'] ?> name="category_id" rows="3"></textarea>
            </div>
            <div class="mb-3">
